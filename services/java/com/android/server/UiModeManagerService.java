...
final class UiModeManagerService extends IUiModeManager.Stub
    ...
    private void updateUiThemeMode() {
        ...
        mUiThemeMode = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                Settings.Secure.UI_THEME_MODE, mContext.getResources().getInteger(com.android.internal.R.integer.config_uiThemeMode),
                UserHandle.USER_CURRENT);

        mConfiguration.uiThemeMode = mUiThemeMode;

        mUiThemeAutoMode = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                Settings.Secure.UI_THEME_AUTO_MODE, 0, UserHandle.USER_CURRENT);
